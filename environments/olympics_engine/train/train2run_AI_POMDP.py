...
from train.algo.active_inference_POMDP import ActiveInference_POMDP_agent

from environments.olympics_engine.core import OlympicsBase
from environments.olympics_engine.objects import *
...
gamemap['objects'].append(Cross(init_pos=[[200, 325], [225, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[200, 375], [225, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[100, 325], [125, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[100, 375], [125, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[400, 325], [425, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[400, 375], [425, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[300, 325], [325, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[300, 375], [325, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[600, 325], [625, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[600, 375], [625, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[500, 325], [525, 350]], length = None, color = 'grey', width = 5))
gamemap['objects'].append(Cross(init_pos=[[500, 375], [525, 350]], length = None, color = 'grey', width = 5))
...
parser.add_argument('--algo', default="active_inference_POMDP", type=str, help="ppo/sac")
...
def main(args):
    ...
    agent = ActiveInference_POMDP_agent(obs_shape=obs_dim, n_action=len(actions_map),
